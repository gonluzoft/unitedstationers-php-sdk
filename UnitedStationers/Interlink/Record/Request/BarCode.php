...
class UnitedStationers_Interlink_Record_Request_BarCode extends UnitedStationers_Interlink_Record_Request_Abstract {
	...
	public function recordFormat(){
		...
		return array(
			...
			array('field'=>'line1', 'length'=>'15'),
			array('field'=>'reserved1', 'length'=>'25')
		);
