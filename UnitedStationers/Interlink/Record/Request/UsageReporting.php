...
class UnitedStationers_Interlink_Record_Request_UsageReporting extends UnitedStationers_Interlink_Record_Request_Abstract {
	const RECORD_TYPE = 'BC';
	...
	public function recordFormat(){
		...
		return array(
			...
			array('field'=>'reportId1', 'length'=>'12'),
			array('field'=>'reserved1', 'length'=>'8'),
			array('field'=>'reportId2', 'length'=>'12'),
			array('field'=>'reserved1', 'length'=>'8')
		);
