...
class UnitedStationers_Interlink_Record_Request_Reconfirm extends UnitedStationers_Interlink_Record_Request_Abstract {
	
	
	const UNITED_TRANSACTION_ID = 'XM02';
	...
	public function recordFormat(){
		...
		return array(
			...
			array('field'=>'mqInterlinkSystemId', 'length'=>'4'),
			...
			array('field'=>'reserved2', 'length'=>'1', 'default'=>self::CONFIRMATION_RECORD_FORMAT),
			
			array('field'=>'reconfirmSingleTransmissionNumber', 'length'=>'5', 'paddingCharacter' => '0'),
			array('field'=>'reconfirmBeginningTransmissionNumber', 'length'=>'5', 'paddingCharacter' => '0'),
			array('field'=>'reconfirmEndingTransmissionNumber', 'length'=>'5', 'paddingCharacter' => '0'),
			array('field'=>'filler2', 'length'=>'38')
		);
